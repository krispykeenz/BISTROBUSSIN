namespace Group_Project_Bistro_Bus
{
    partial class RemoveEmployeesFrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tbEmployeeNumber.ToolTip = "Enter employee number to search";
            tbFirstName.ToolTip = "First name will populate after searching";
            tbLastName.ToolTip = "Last name will populate after searching";
            tbEmail.ToolTip = "Email will populate after searching";
            tbCell.ToolTip = "Cell number will populate after searching";
            tbTaxNumber.ToolTip = "Tax number will populate after searching";
            tbEmployeeRole.ToolTip = "Role will populate after searching";
            btnFind.ToolTip = "Click to search for employee";
            btnRemove.ToolTip = "Click to remove employee";
            btnBack.ToolTip = "Click to go back";
            //
            // panel1
            // 
